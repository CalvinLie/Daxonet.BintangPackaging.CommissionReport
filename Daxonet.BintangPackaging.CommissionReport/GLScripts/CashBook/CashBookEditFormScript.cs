...
{
    /// <summary>
    /// Implements script for CashBookEditForm.
    /// </summary>
    public class CashBookEditFormScript
    {
        /// <summary>
		/// Use this event to do form initialization
		/// </summary>
		/// <param name="e">The event argument</param>
        public void OnFormInitialize(AutoCount.GL.CashBook.FormCashBookEntry.FormInitializeEventArgs e)
        {
        }
